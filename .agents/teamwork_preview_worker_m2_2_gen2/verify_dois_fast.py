    ...
    if existing_doi:
        ...
        if meta.get("valid"):
            ...
            if code == 200 and sim >= 0.60:
                ...
                status = "BROKEN_HTTP"
                notes = f"Existing DOI HTTP {code}"
            else:
                status = "HALLUCINATED"
...
print("Fast DOI Verification Complete! Saved to .agents/teamwork_preview_worker_m2_2_gen2/doi_audit_results.json")
